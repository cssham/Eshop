            ...
            <div class="col-md-12">
              ...
              <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <textarea class="form-control" id="summary-ckeditor" name="long_description">
                    ...
                    <br>
                    <img src="{{ URL::to('public/storage/product/'.$product->image) }}" alt="{{ Str::limit($product->image)}}" style="height: 120px; width:150px">
                    <div class="row">
                      <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <input type="checkbox" id="publish" name="status" class="filled-in" value="1" {{ $product->status ==true ? 'checked':'' }}>
