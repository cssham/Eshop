...
@section('title','Eshop | Product Details')
        ...
        <div class="row">
                ...
                <div class="img-tab-area">
                    <div class="tab-content tab-img">
                        <div class="tab-pane fade show active" id="img1" role="tabpane">
                            <img class="img-fluid" src="{{ asset('public/storage/product/'.$product->image) }}" alt="">
                        </div>
                        <div class="tab-pane fade" id="img2" role="tabpanel">
                            <img class="img-fluid" src="{{ asset('public/storage/product/'.$product->image) }}" alt="">
                        </div>
                        <div class="tab-pane fade" id="img3" role="tabpanel">
                            <img class="img-fluid" src="{{ asset('public/frontend/img/pro-det-tab-img/3.jpg') }}"
                                alt="">
                        </div>
                    </div>
            ...
            <div class="col-md-5">
                ...
                <div class="options-area">
                    ...
                    <form method="POST" action="{{ route('add_to_cart') }}" class="cart-and-action">
                        @csrf
            ...
            <div class="product-active owl-carousel nav-style">
                ...
                <div class="product-wrapper">
                    <div class="product-img">
                        <a href="{{ route('frontend.product.details',$product->id) }}"> <img
                                src="{{ asset('public/storage/product/'.$product->image) }}" alt=""></a>
