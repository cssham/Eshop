                ...
                @csrf
                   <table class="table table-bordered table-hover">
                       ...
                       <tr>
                           ...
                           <td>
                                <div class="form-check">
                                   <input class="form-check-input" name="payment_type" type="radio" value="Rocket" id="forRocket">
                                   <label class="form-check-label" for="forRocket">
                                        Rocket
                                   </label>
                               </div>
                           </td>
