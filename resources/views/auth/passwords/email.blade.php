                ...
                <div class="p-5">
                  ...
                  <form class="user" method="POST" action="{{ route('password.email') }}">
                    ...
                    <div class="form-group">
                     ...
                     <button onclick="showMessage()" type="submit" class="btn btn-primary btn-user btn-block">
...
<script>
 function showMessage(){
        document.getElementById("msg").innerHTML="Check your Email for reset your Password !"
    }
</script>
